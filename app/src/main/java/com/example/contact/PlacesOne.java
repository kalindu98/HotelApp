...
public class PlacesOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_places_one);
        ...
        second_back_arrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PlacesOne.this, Places.class);
        ...
        second_arrow_up.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PlacesOne.this, PlacesTwo.class);
                Pair[] pairs = new Pair[1];
                pairs[0] = new Pair<View, String>(second_arrow_up, "background_image_transition");
                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(PlacesOne.this, pairs);
